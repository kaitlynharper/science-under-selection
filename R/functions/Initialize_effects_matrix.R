...
initialize_effects_matrix <- function(sim_env) {
  ...
  # Initialize posterior (so that the first study will have the uninformed prior as the existing posterior)
  ...
  # row index of latest belief for each effect_id
